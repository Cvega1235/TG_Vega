...
GMAPS_SELECTORS = {
    ...
    'direccion': 'button[data-item-id="address"]',
    'direccion_fallback': 'div.rogA2c',
    'telefono': 'button[data-item-id*="phone"]',
    'telefono_fallback': 'div.AeaXub span',
    'rating': 'div.F7nice span[aria-hidden="true"]',
    'rating_fallback': 'div.jANrlb span',
    'num_resenas': 'button[jsaction*="pane.reviewChart"] span',
    'num_resenas_fallback': 'div.F7nice span:nth-of-type(2)',
    'categoria': 'button[jsaction*="pane.rating.category"]',
