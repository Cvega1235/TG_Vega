...
function StatCard({ title, value, color, bg, iconBg, icon }: CardDef) {
  return (
    <div className={`${bg} rounded-xl p-5 shadow-sm flex items-center gap-4`}>
